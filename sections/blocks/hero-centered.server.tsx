...
export const heroCentered: SectionRenderer<'heroCentered'> = (b, { key: k }) => (
  <section key={k} aria-labelledby={`${k}-t`} className="relative isolate mx-auto mb-6 flex w-full max-w-[var(--hero-one-w,1250px)] flex-col px-6 pt-10 pb-4 text-center">
