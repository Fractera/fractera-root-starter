...
// Дверь подгруппы «finance». Форма одинакова у всех четырёх намеренно: увидев один
...
export default async function Layout(
  ...
  return (
    <AccessGate roles={PROTECTED_GROUP_ROLES.finance} lang={lang} ui={accessGateUi(lang)} dialogUi={appDialogUi(lang)}>
      ...
      <FlowRail group="finance" label={accountLabels(lang).groupFinance} />
      {children}
    </AccessGate>
  )
}
