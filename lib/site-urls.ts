...
// 🪦 `chatUrlFromSite()` БЫЛ УБРАН 2026-09-05 (ревизия, шаг 116) вместе со ссылкой на чат в
// подвале — его единственным потребителем. Служба `:3600` жива, но перестала быть путём к
// агенту.
//
// ✅ ВОССТАНОВЛЕН ТЕМ ЖЕ ДНЁМ, ШАГ 137, И ДОСЛОВНО — из коммита `17a6917`, а не написан
// заново. Надгробие сказало, где искать, и это единственная причина, по которой удаление
// было законным: восстановленная функция обязана совпасть с прежней, иначе «вернули» и
// «написали похожее» становятся неразличимы.
//
// 🔒 ПОТРЕБИТЕЛЬ У НЕЁ ДРУГОЙ, ЧЕМ БЫЛ. Прежде она вела на чат как на путь к агенту —
// путь закрыт решением владельца, и это не отменено. Теперь она ведёт на СТРАНИЦУ БОТА,
// переехавшую с `:3000` на `:3600` (шаг 137): «если пользователь, которому не нужен сайт,
