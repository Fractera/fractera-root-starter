  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <header className={`flex flex-col gap-4 ${divider ? "border-b border-border pb-8" : ""}`}>
        ...
        {/* 🔒 ПУСТОЙ ЗАГОЛОВОК НЕ РИСУЕТ ПУСТОЙ H1 (230-6, 2026-09-18). Страница
            без заголовка бывает — главная, у которой содержимого ещё нет. Пустой
            <h1></h1> в разметке хуже отсутствующего: это единственный заголовок
            первого уровня на странице, и поисковик читает его как заявленный и
            не заполненный. */}
